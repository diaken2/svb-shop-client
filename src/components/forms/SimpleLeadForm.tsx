...
interface SimpleLeadFormProps {
  ...
  ctaLabel: string;
  accent?: "blue" | "purple" | "green" | "indigo" | "orange";
  ...
  return (
    ...
    >
      <Card className="overflow-hidden border border-gray-100 ring-1 ring-black/5 shadow-xl rounded-3xl">
        <div
          className={`bg-gradient-to-r ${colorMap[accent]} text-white px-6 py-6 md:py-8`}
        >
        ...
        <CardContent className="p-6">
          <div className={`grid gap-3 ${compact ? "grid-cols-1" : "grid-cols-1 md:grid-cols-3"}`}>
            ...
            />
            <Button
              className={`w-full md:w-auto bg-gradient-to-r ${buttonColorMap[accent]} text-white hover:brightness-110 md:justify-self-start rounded-xl shadow-lg hover:shadow-xl`}
